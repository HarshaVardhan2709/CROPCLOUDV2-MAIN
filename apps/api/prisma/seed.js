...
async function main() {
    ...
    const roles = await Promise.all(Object.values(client_1.RoleType).map((name) => prisma.role.create({ data: { name } })));
    ...
    const admin = await prisma.user.create({
        data: {
            ...
            isPrimaryAdmin: true,
            adminApprovalStatus: client_1.AdminApprovalStatus.APPROVED,
            cart: { create: {} },
            wishlist: { create: {} },
        },
    });
        ...
        data: {
            ...
            sellerProfile: {
                create: {
                    ...
                    approvalStatus: client_1.SellerStatus.APPROVED,
                    latitude: 17.3850,
                    longitude: 78.4867,
                    city: 'Hyderabad',
                    state: 'Telangana',
        ...
        data: [
            {
                ...
                mode: client_1.DeliveryMode.PINCODE,
            ...
            {
                sellerProfileId: seller.sellerProfile.id,
                mode: client_1.DeliveryMode.RADIUS,
    ...
    const lettuce = await prisma.product.create({
        data: {
            ...
            bestDeal: true,
            seasonal: true,
            approvalStatus: client_1.ProductApprovalStatus.APPROVED,
            approvedAt: new Date(),
            images: {
                create: [
